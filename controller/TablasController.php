...
switch ($_REQUEST["operador"]) {
    ...
    case "registrar_Tiempovivir":
        if (isset($_POST["descripcion"]) && !empty($_POST["descripcion"])) {
            ...
            $result = $tablas->RegistrarTiempovivir($Descripcion);
            if($result == "existe"){

                $response = "existe";

            }else if($result == "inserto") {
                $bita->RegistrarBitacora($_SESSION["user"]["idUsuario"], 20, "Inserto", "Inserto el tiempo de vivir: ".$Descripcion);
                $response = "success";  //si se inserto en la BD manda mensaje de exito
            } else {
                $response = "error";
            }
    ...
    case "actualizar_tiempovivir":
        if (isset($_POST["idtiempoVivir"], $_POST["descripcion"])  && !empty($_POST["idtiempoVivir"]) && !empty($_POST["descripcion"])) {
            ...
            $result = $tablas->ActualizarTiempovivir($idtiempoVivir, $descripcion);
            if($result == "existe"){

                $response = "existe";

            }else if($result == "inserto") {
                $bita->RegistrarBitacora($_SESSION["user"]["idUsuario"], 20, "Modifico", "Modificó el tiempo de vivir: ".$descripcion);
                $response = "success";  //si se inserto en la BD manda mensaje de exito
    ...
    case "eliminar_Tiempovivir":
        if (isset($_POST["idtiempoVivir"]) && !empty($_POST["idtiempoVivir"])) {
            ...
            if ($eliminar == "elimino") {
                $bita->RegistrarBitacora($_SESSION["user"]["idUsuario"], 20, "Elimino", "Elimino el tiempo de vivir con id: ".$_POST["idtiempoVivir"]);
                $response = "success";  //si elimino correctamente
    ...
    case "registrar_Estadosolicitud":
        if (isset($_POST["Descripcion"]) && !empty($_POST["Descripcion"])) {
            ...
            if($result == "existe"){
                ...
                $bita->RegistrarBitacora($_SESSION["user"]["idUsuario"], 22, "Inserto", "Inserto el estado de solicitud: ".$descripcion);
                $response = "success";  //si se inserto en la BD manda mensaje de exito
            } else {
                $response = "error";
            }
    ...
    case "registrar_Rubro":
        if (isset($_POST["Descripcion"]) && !empty($_POST["Descripcion"])) {
            ...
            if ($tablas->RegistrarRubro($descripcion)) {
                $bita->RegistrarBitacora($_SESSION["user"]["idUsuario"], 23, "Inserto", "Inserto el rubro: ".$descripcion);
                $response = "success";  //si se inserto en la BD manda mensaje de exito
            } else {
                $response = "error";
            }
    ...
    case "actualizar_rubro":
        if (isset($_POST["idRubro"], $_POST["Descripcion"])  && !empty($_POST["idRubro"]) && !empty($_POST["Descripcion"])) {
            ...
            if ($tablas->ActualizarRubro($idRubro, $Descripcion)) {
                $bita->RegistrarBitacora($_SESSION["user"]["idUsuario"], 23, "Modifico", "Modificó el rubro: ".$Descripcion);
                $response = "success";  //si se inserto en la BD manda mensaje de exito
    ...
    case "eliminar_Rubro":
        if (isset($_POST["idRubro"]) && !empty($_POST["idRubro"])) {
            ...
            if ($eliminar == "elimino") {
                $bita->RegistrarBitacora($_SESSION["user"]["idUsuario"], 23, "Elimino", "Elimino el rubro con id: ".$_POST["idRubro"]);
                $response = "success";  //si elimino correctamente
