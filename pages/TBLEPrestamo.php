...
if (isset($_SESSION["user"])) {
	...
	$tiene_permiso = $permiso->ListarPermisosRol(21, $rol);
	...
	$bita = new Bitacora();
	$bita->RegistrarBitacora($_SESSION["user"]["idUsuario"], 21, "Ingreso", "Ingreso a la pantalla de estado tipo préstamos");	
?>
	<!--==========================================-->
			...
			<div class="content-body">
				<section id="basic-form-layouts">
					<div class="row match-height">
						<!-- tabla estado tipo prestamo-->
						<div class="col-md-18">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title" id="basic-layout-form">
										<h4>
											<center>Estado Tipo Préstamo</center>
										</h4>
										<?php
										if ($tiene_permiso && $tiene_permiso["insertar"] >= 1) {
											echo '<button class="btn btn-success" data-toggle="modal" data-target="#registral_Estadotipoprestamo"><span class="icon-plus"></span> Nuevo</button>';
										}
										if ($tiene_permiso &&  $tiene_permiso["reportes"] >= 1) {
											echo '<button id="btn_descargar_reporteEstadoTipoPrestamo_pdf" class="btn btn-danger"> <i class="fas icon-file-pdf"></i> Descargar Listado</button>';
										} ?>
									</h4>
								...
								<div class="card-body collapse in">
									<div class="card-block">
										<div class="table-responsive">
											<table id="tabla_Estadotipoprestamo" class="table table-bordered table-sm">
												<thead>
													<tr>
														<th>Acciones</th>
														<th>No.</th>
														<th>Estado Tipo Prestamo</th>
	...
	include "Modals/Registrar/RegistrarEstadotipoprestamo.php";
	...
	include "Modals/Actualizar/ActualizarEstadotipoprestamo.php";
	...
	<script src="../assets/js/listadoEstadoTipoPrestamo.js"></script>
	<!-- Advertencias Toastr -->
   ...
   <script>
	window.addEventListener('beforeunload', function (event) {  //funcion para registrar salidas
		...
		var pantallaId = 21; // ID de la pantalla en la cual se esta registrado el evento
		var accion = "Salio"; // Acción del evento
		var descripcion = "Salió de la pantalla de estado tipo préstamos"; // Descripción de la acción
