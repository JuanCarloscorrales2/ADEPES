...
if (isset($_SESSION["user"])) {
	...
	$bita = new Bitacora();
	$bita->RegistrarBitacora($_SESSION["user"]["idUsuario"], 31, "Ingreso", "Ingreso a la pantalla de Bitácora");
...
?>
	...
	<script>
		window.addEventListener('beforeunload', function (event) {
			...
			var pantallaId = 31; // ID de la pantalla en la cual se esta registrado el evento
			var accion = "Salio"; // Acción del evento
			var descripcion = "Salió de la pantalla de Bitácora"; // Descripción de la acción
