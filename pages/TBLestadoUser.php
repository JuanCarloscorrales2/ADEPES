...
?>
							...
							<div class="card">
								<div class="card-header">
									<h4 class="card-title" id="basic-layout-form">
										<h4>
											<center>Estado Usuario</center>
										</h4>


										<?php
										if ($tiene_permiso && $tiene_permiso["insertar"] >= 1) {
											echo '<button class="btn btn-success" data-toggle="modal" data-target="#RegistrarEstadoUser"><span class="icon-plus"></span> Nuevo</button>';
										}
										if ($tiene_permiso &&  $tiene_permiso["reportes"] >= 1) {

											echo '<button id="btn_descargar_reporteEstado_pdf" class="btn btn-danger"> <i class="fas icon-file-pdf"></i> Descargar Listado</button>';
										} ?>
								...
								<div class="card-body collapse in">
									<div class="card-block">
										<div class="table-responsive">
											<table id="tabla_estadoUser" class="table table-bordered table-sm">
												<thead>
													<tr>
														<th>Acciones</th>
														<th>No.</th>
	...
	include "Modals/Registrar/RegistrarEstadoUser.php";
	...
	include "Modals/Actualizar/ActualizarEStadoUser.php";
