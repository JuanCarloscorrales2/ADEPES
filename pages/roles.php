...
if (isset($_SESSION["user"])) {
	...
	$bita = new Bitacora();
	$bita->RegistrarBitacora($_SESSION["user"]["idUsuario"], 9, "Ingreso", "Ingreso a la pantalla de roles");
?>
	<!--==========================================-->
...
<script src="../app-assets/plugins/toastr/toastr.min.js">  </script> 
	...
	<script>
		window.addEventListener('beforeunload', function (event) {
			...
			var pantallaId = 9; // ID de la pantalla en la cual se esta registrado el evento
			var accion = "Salio"; // Acción del evento
			var descripcion = "Salió de la pantalla de roles"; // Descripción de la acción
