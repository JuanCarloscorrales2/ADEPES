...
if (isset($_SESSION["user"])) {
	...
	//bitacora
$bita = new Bitacora();
$bita->RegistrarBitacora($_SESSION["user"]["idUsuario"], 8, "Ingreso", "Ingreso a la pantalla de cobros");
?>
	<!--==========================================-->
	...
	<script>
		window.addEventListener('beforeunload', function (event) {
			...
			var pantallaId = 8; // ID de la pantalla en la cual se esta registrado el evento
			var accion = "Salio"; // Acción del evento
			var descripcion = "Salió de la pantalla de cobros"; // Descripción de la acción
