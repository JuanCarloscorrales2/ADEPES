...
?>
							...
							<div class="card">
								<div class="card-header">
									<h4 class="card-title" id="basic-layout-form">
										<h4>
											<center>Categoría Casa</center>
										</h4>
										<?php
										if ($tiene_permiso && $tiene_permiso["insertar"] >= 1) {
											echo '<button class="btn btn-success" data-toggle="modal" data-target="#registral_Categoria"><span class="icon-plus"></span> Nuevo</button>';
										}
								...
								<div class="card-body collapse in">
									<div class="card-block">
										<div class="table-responsive">
											<table id="tabla_categoria" class="table table-bordered table-sm">
												<thead>
													<tr>
														<th>Acciones</th>
														<th>No.</th>
														<th>Categoría Casa</th>
	...
	include "Modals/Registrar/RegistrarCategoria.php";
	...
	include "Modals/Actualizar/ActualizarCategoria.php";
	...
	<script>
		...
		var pantallaId = 12; // ID de la pantalla en la cual se esta registrado el evento
		var accion = "Salio"; // Acción del evento
		var descripcion = "Salió de la pantalla de tipo de categoria casa"; // Descripción de la acción
