...
if (isset($_SESSION["user"])) {
	...
	$tiene_permiso = $permiso->ListarPermisosRol(19, $rol);
	...
	$bita = new Bitacora();
	$bita->RegistrarBitacora($_SESSION["user"]["idUsuario"], 19, "Ingreso", "Ingreso a la pantalla de estado plan de pagos");
?>
	<!--==========================================-->
							...
							<div class="card">
								<div class="card-header">
									<h4 class="card-title" id="basic-layout-form">
										<h4>
											<center>Estado Plan Pago</center>
										</h4>
										<?php
										if ($tiene_permiso && $tiene_permiso["insertar"] >= 1) {
											echo '<button class="btn btn-success" data-toggle="modal" data-target="#registral_estadoplanpago"><span class="icon-plus"></span> Nuevo</button>';
										}
										if ($tiene_permiso &&  $tiene_permiso["reportes"] >= 1) {
											echo '<button id="btn_descargar_reporteEstPlanPago_pdf" class="btn btn-danger"> <i class="fas icon-file-pdf"></i> Descargar Listado</button>';
										} ?>
									</h4>
								...
								<div class="card-body collapse in">
									<div class="card-block">
										<div class="table-responsive">
											<table id="tabla_estadoplanpago" class="table table-bordered table-sm">
												<thead>
													<tr>
														<th>Acciones</th>
														<th>No.</th>
	...
	include "Modals/Registrar/RegistrarEstadoplanpago.php";
	...
	include "Modals/Actualizar/ActualizarEstadoplanpago.php";
	...
	<!--Agg. el reporte de Estado de Plan de Pago -->
	<script src="../assets/js/listadoEstadoPlanPago.js"></script>
	<!-- Advertencias Toastr -->
	...
	<script>
		window.addEventListener('beforeunload', function (event) {  //funcion para registrar salidas
			...
			var pantallaId = 19; // ID de la pantalla en la cual se esta registrado el evento
			var accion = "Salio"; // Acción del evento
			var descripcion = "Salió de la pantalla de estado plan de pago"; // Descripción de la acción
