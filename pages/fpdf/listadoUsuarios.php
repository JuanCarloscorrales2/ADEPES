<?php  
    ...
    //Generar el PDF utilizando la Libreria de FPDF
        ...
        foreach ($datosFiltradosOrdenados as $fila) {
            //$pdf->Cell(18, 10, $fila['id'], 1, 0, 'C', 0); //LOS NOMBRE SON DE LA FUNCION: LlenarTablaUsuario  JS
            $pdf->Cell(40, 10, $fila['Usuario'], 1, 0, 'C', 0);
            $pdf->Cell(50, 10, $fila['Nombre'], 1, 0, 'C', 0);
            $pdf->Cell(45, 10, utf8_decode($fila['Rol']), 1, 0, 'C', 0);
            $pdf->Cell(25, 10, $fila['Estado'], 1, 0, 'C', 0);
            $pdf->Cell(60, 10, $fila['Correo'], 1, 0, 'J', 0);
            $pdf->Cell(42, 10, $fila['Fecha'], 1, 1, 'C', 0);
        //$pdf->Ln();
