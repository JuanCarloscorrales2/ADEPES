    ...
    //Generar el PDF utilizando la Libreria de FPDF
        ...
        class PDF extends FPDF{
            ...
            function Header(){
                ...
                $this->Cell(200, 15, utf8_decode('ASOCIACIÓN DE DESARROLLO PESPIRENSE'), 0, 1, 'C', 0); // AnchoCelda,AltoCelda,titulo,borde(1-0),saltoLinea(1-0),posicion(L-C-R),ColorFondo(1-0)
                $this->Cell(160, 2, utf8_decode('"ADEPES"'), 0, 1, 'R', 0);
                ...
                $this->Cell(52, 10, utf8_decode("LISTADO DE ROLES"), 0, 1, 'C', 0);
                $this->Ln(7);
                ...
                $this->Cell(55, 10, utf8_decode('ROL'), 1, 0, 'C', 1);
                $this->Cell(140, 10, utf8_decode('DESCRIPCIÓN'), 1, 0, 'C', 1);
                $this->Cell(50, 10, utf8_decode('FECHA DE CREACIÓN'), 1, 1, 'C', 1);
        ...
        foreach ($datosFiltradosOrdenados as $fila) {
            //$pdf->Cell(18, 10, $fila['id'], 1, 0, 'C', 0); //LOS NOMBRE SON DE LA FUNCION: LlenarTablaRol  JS
            $pdf->Cell(55, 10, utf8_decode($fila['Rol']), 1, 0, 'J', 0);
            $pdf->Cell(140, 10, utf8_decode($fila['Descripcion']), 1, 0, 'J', 0);
