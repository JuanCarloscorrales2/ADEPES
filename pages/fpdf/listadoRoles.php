    ...
    //Generar el PDF utilizando la Libreria de FPDF
        ...
        class PDF extends FPDF{
            ...
            function Header(){
                ...
                $this->Cell(105, 2, utf8_decode('"ADEPES"'), 0, 1, 'R', 0);
                ...
                $this->Cell(5, 10, utf8_decode("LISTADO DE ROLES"), 0, 1, 'R', 0);
                $this->Ln(7);
                ...
                $this->Cell(45, 10, utf8_decode('FECHA DE CREACIÓN'), 1, 1, 'C', 1);
            ...
            function Footer()
            {
                ...
                $this->Cell(340, 10, utf8_decode('Fecha y Hora de impresión: '.$hoy), 0, 0, 'C');
 ...
 /******************************* METODO PARA AJUSTAR CELDAS ********************************** */
   ...
   function NbLines($w, $txt)
   {
       ...
       return $nl;
        ...
        $pdf->setWidths(array(10, 55, 80, 45)); //tamano de las celdas segun el encabezado de la tabla
