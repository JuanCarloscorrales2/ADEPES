...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(20, 10, utf8_decode("LISTADO DE CLIENTES"), 0, 1, 'C', 0);
      $this->Ln(7);
     ...
     $this->Cell(25, 10, utf8_decode('CONTACTO'), 1, 0, 'C', 1);
     $this->Cell(70, 10, utf8_decode('DIRECCIÓN'), 1, 0, 'C', 1);
     $this->Cell(42, 10, utf8_decode('PROFESIÓN'), 1, 0, 'C', 1);
     $this->Ln();
...
foreach ($datosFiltradosOrdenados as $fila) {
    ...
    $pdf->Row(array($i++, $fila['Nombre'], $fila['Identidad'], $fila['Genero'],  $fila['Contacto'], $fila['Direccion'], $fila['Profesion']), 0 );
