...
if (isset($_SESSION["user"])) {
	...
	$tiene_permiso = $permiso->ListarPermisosRol(39, $rol);
...
?>
								...
								<div class="card-header">
									<h4 class="card-title" id="basic-layout-form">
										...
										if ($tiene_permiso && $tiene_permiso["insertar"] >= 1) {
											echo '<button class="btn btn-success" data-toggle="modal" data-target="#registral_objetos"><span class="icon-plus"></span> Nuevo</button>';
										} ?>
										<?php
								...
								<div class="card-body collapse in">
									<div class="card-block">
										<div class="table-responsive">
											<table id="tabla_objetos" class="table table-bordered table-sm">
												<thead>
													<tr>
														<th>Acciones</th>
														<th>No.</th>
	...
	include "Modals/Registrar/RegistrarObjetos.php";
	...
	include "Modals/Actualizar/ActualizarObjetos.php";
