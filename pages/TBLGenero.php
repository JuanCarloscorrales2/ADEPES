...
if (isset($_SESSION["user"])) {
	...
	$tiene_permiso = $permiso->ListarPermisosRol(14, $rol);
	...
	$bita = new Bitacora();
	$bita->RegistrarBitacora($_SESSION["user"]["idUsuario"], 14, "Ingreso", "Ingreso a la pantalla de genero");
?>
	<!--==========================================-->
								...
								<div class="card-header">
									<h4 class="card-title" id="basic-layout-form">
										...
										if ($tiene_permiso && $tiene_permiso["insertar"] >= 1) {
											echo '<button class="btn btn-success" data-toggle="modal" data-target="#registral_Genero"><span class="icon-plus"></span> Nuevo</button>';
										}
										if ($tiene_permiso &&  $tiene_permiso["reportes"] >= 1) {
											echo '<button id="btn_descargar_reporteGenero_pdf" class="btn btn-danger"> <i class="fas icon-file-pdf"></i> Descargar Listado</button>';
										} ?>
									</h4>
								...
								<div class="card-body collapse in">
									<div class="card-block">
										<div class="table-responsive">
											<table id="tabla_genero" class="table table-bordered table-sm">
												<thead>
													<tr>
														<th>Acciones</th>
														<th>No.</th>
	...
	include "Modals/Registrar/RegistrarGenero.php";
	...
	include "Modals/Actualizar/ActualizarGenero.php";
	...
	<script src="../assets/js/listadoGenero.js"></script> <!--Agg. el reporte de Genero -->
	...
	<script>
		...
		var pantallaId = 14; // ID de la pantalla en la cual se esta registrado el evento
		var accion = "Salio"; // Acción del evento
		var descripcion = "Salió de la pantalla de genero"; // Descripción de la acción
