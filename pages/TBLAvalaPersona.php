...
if (isset($_SESSION["user"])) {
	...
	$tiene_permiso = $permiso->ListarPermisosRol(37, $rol);
...
?>
							...
							<div class="card">
								<div class="card-header">
									<h4 class="card-title" id="basic-layout-form">
										<h4>
											<center>Avala a Persona</center>
										</h4>
										<?php
										if ($tiene_permiso && $tiene_permiso["insertar"] >= 1) {
											echo '<button class="btn btn-success" data-toggle="modal" data-target="#registral_Avala"><span class="icon-plus"></span> Nuevo</button>';
										} ?>
										<?php
										if ($tiene_permiso &&  $tiene_permiso["reportes"] >= 1) {
											echo '<button id="btn_descargar_rAvalaPersona_pdf" class="btn btn-danger"> <i class="fas icon-file-pdf"></i> Descargar Listado</button>';
										} ?>
									</h4>
								...
								<div class="card-body collapse in">
									<div class="card-block">
										<div class="table-responsive">
											<table id="tabla_avala" class="table table-bordered table-sm">
												<thead>
													<tr>
														<th>Acciones</th>
														<th>No.</th>
														<th>Avala a Persona</th>
	...
	include "Modals/Registrar/RegistrarAvala.php";
	...
	include "Modals/Actualizar/ActualizarAvala.php";
	...
	<!--Agg. los reportes de  -->
	<script src="../assets/js/listadoAvalaPersona.js"></script>
