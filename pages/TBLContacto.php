...
if (isset($_SESSION["user"])) {
	...
	$tiene_permiso = $permiso->ListarPermisosRol(15, $rol);
...
?>
							...
							<div class="card">
								<div class="card-header">
									<h4 class="card-title" id="basic-layout-form">
										<h4>
											<center>Tipo Contacto</center>
										</h4>
										<?php
										if ($tiene_permiso && $tiene_permiso["insertar"] >= 1) {
											echo '<button class="btn btn-success" data-toggle="modal" data-target="#registral_Contacto"><span class="icon-plus"></span> Nuevo</button>';
										}
										if ($tiene_permiso &&  $tiene_permiso["reportes"] >= 1) {
											echo '<button id="btn_descargar_reporteContacto_pdf" class="btn btn-danger"> <i class="fas icon-file-pdf"></i> Descargar Listado</button>';
										} ?>
									</h4>
								...
								<div class="card-body collapse in">
									<div class="card-block">
										<div class="table-responsive">
											<table id="tabla_contacto" class="table table-bordered table-sm">
												<thead>
													<tr>
														<th>Acciones</th>
														<th>No.</th>
	...
	include "Modals/Registrar/ResgistrarContacto.php";
	...
	include "Modals/Actualizar/ActualizarContacto.php";
	...
	<script src="../assets/js/listadoContacto.js"></script>
	...
	<script>
		...
		var pantallaId = 15; // ID de la pantalla en la cual se esta registrado el evento
		var accion = "Salio"; // Acción del evento
		var descripcion = "Salió de la pantalla de tipo de tipo contacto"; // Descripción de la acción
