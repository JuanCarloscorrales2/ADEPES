...
if (isset($_SESSION["user"])) {
	...
	$tiene_permiso = $permiso->ListarPermisosRol(22, $rol);
	...
	$bita = new Bitacora();
	$bita->RegistrarBitacora($_SESSION["user"]["idUsuario"], 22, "Ingreso", "Ingreso a la pantalla de estado de solicitudes");
?>
	<!--==========================================-->
							...
							<div class="card">
								<div class="card-header">
									<h4 class="card-title" id="basic-layout-form">
										<h4>
											<center>Estado Solicitudes</center>
										</h4>
										<?php
										if ($tiene_permiso && $tiene_permiso["insertar"] >= 1) {
											echo '<button class="btn btn-success" data-toggle="modal" data-target="#registral_Estadosolicitud"><span class="icon-plus"></span> Nuevo</button>';
										}
										if ($tiene_permiso &&  $tiene_permiso["reportes"] >= 1) {
											echo '<button id="btn_descargar_reporteEstadoSolicitud_pdf" class="btn btn-danger"> <i class="fas icon-file-pdf"></i> Descargar Listado</button>';
										} ?>
									</h4>
								...
								<div class="card-body collapse in">
									<div class="card-block">
										<div class="table-responsive">
											<table id="tabla_estadosolicitud" class="table table-bordered table-sm">
												<thead>
													<tr>
														<th>Acciones</th>
														<th>No.</th>
	...
	include "Modals/Registrar/RegistrarEstadosolicitud.php";
	...
	include "Modals/Actualizar/ActualizarEstadosolicitud.php";
	...
	<script src="../assets/js/listadoEstadoSolicitud.js"></script>
	...
	<script>
		window.addEventListener('beforeunload', function (event) {  //funcion para registrar salidas
			...
			var pantallaId = 22; // ID de la pantalla en la cual se esta registrado el evento
			var accion = "Salio"; // Acción del evento
			var descripcion = "Salió de la pantalla de estado de solicitudes"; // Descripción de la acción
