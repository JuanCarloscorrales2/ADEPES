<?php
include './Connet.php';
$nombre="SistemaWebAdepes";
$day=date("d");
$mont=date("m");
$year=date("Y");
$hora=date("H-i-s");
$fecha=$day.'_'.$mont.'_'.$year;
$DataBASE=$nombre."_".$fecha."_(".$hora."_hrs).sql";
$tables=array();
...
if($result){
    ...
    if($error==1){
        ...
        if(fwrite($handle, $sql)){
            ...
            alert('Copia de seguridad realizada con éxito! Su archivo se ha guardado en: " . BACKUP_PATH . $DataBASE . "');
            window.location.href='../pages/backup.php';
          </script>";
