...
<div class="app-content content container-fluid">
	<div class="content-wrapper">
		...
		<div class="content-body ">
			...
			<!--
				<button type="button" class="btn btn-success" style="float: right;" onclick="nextSteps('step1', 'step2')"><span class="icon-arrow-right"></span>Siguiente</button>
			...
			<div id="step1" class="step"> <!-- inicio paso 1 -->
			...
			<div id="step2" class="step" style="display: none;"> <!-- inicio paso 2 -->
		...
		<div id="step3" class="step" style="display: none;"> <!-- inicio del paso 3 -->
		...
		<div id="step4" class="step" style="display: none;">
			<div class="rz-card card" id="rz-card-analisis" style="width: 100%" >
				...
				<div class="button-container">
					...
					<button class="btn btn-info" style="float: right;" onclick="RegistrarAval();">Guardar</button>
...
<script src="../assets/js/SolicitudNuevaAval.js"></script>
