...
if (isset($_SESSION["user"])) {
	...
	$tiene_permiso = $permiso->ListarPermisosRol(40, $rol);
...
?>
								...
								<div class="card-header">
									<h4 class="card-title" id="basic-layout-form">
										...
										if ($tiene_permiso && $tiene_permiso["insertar"] >= 1) {
											echo '<button class="btn btn-success" data-toggle="modal" data-target="#registral_Tipocuenta"><span class="icon-plus"></span> Nuevo</button>';
										} ?>
										<?php
										if ($tiene_permiso &&  $tiene_permiso["reportes"] >= 1) {
											echo '<button id="btn_descargar_rTipoCta_pdf" class="btn btn-danger"> <i class="fas icon-file-pdf"></i> Descargar Listado</button>';
										} ?>
									</h4>
								...
								<div class="card-body collapse in">
									<div class="card-block">
										<div class="table-responsive">
											<table id="tabla_tipocuenta" class="table table-bordered table-sm">
												<thead>
													<tr>
														<th>Acciones</th>
														<th>No.</th>
	...
	include "Modals/Registrar/RegistrarTipoCuenta.php";
	...
	include "Modals/Actualizar/ActualizarTipoCuenta.php";
	...
	<script src="../assets/js/listadoTipoCuenta.js"></script>
