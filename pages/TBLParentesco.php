...
if (isset($_SESSION["user"])) {
	...
	$tiene_permiso = $permiso->ListarPermisosRol(13, $rol);
	...
	$bita = new Bitacora();
$bita->RegistrarBitacora($_SESSION["user"]["idUsuario"], 13, "Ingreso", "Ingreso a la pantalla de tipo de parentesco");
?>
	<!--==========================================-->
							...
							<div class="card">
								<div class="card-header">
									<h4 class="card-title" id="basic-layout-form">
										<h4>
											<center>Parentescos</center>
										</h4>
										<?php
										if ($tiene_permiso && $tiene_permiso["insertar"] >= 1) {
											echo '<button class="btn btn-success" data-toggle="modal" data-target="#registral_Parentesco"><span class="icon-plus"></span> Nuevo</button>';
										}
										if ($tiene_permiso &&  $tiene_permiso["reportes"] >= 1) {
											echo '<button id="btn_descargar_rParentesco_pdf" class="btn btn-danger"> <i class="fas icon-file-pdf"></i> Descargar Listado</button>';
										} ?>
									</h4>
	...
	include "Modals/Registrar/RegistrarParentesco.php";
	...
	include "Modals/Actualizar/ActualizarParentesco.php";
	...
	<!--Agg. el reporte de Parentescos -->
	<script src="../assets/js/listadoParentesco.js"></script>
	...
	<script>
		...
		var pantallaId = 13; // ID de la pantalla en la cual se esta registrado el evento
		var accion = "Salio"; // Acción del evento
		var descripcion = "Salió de la pantalla de tipo de tipo de parentesco"; // Descripción de la acción
