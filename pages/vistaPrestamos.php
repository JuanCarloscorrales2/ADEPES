...
?>
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-xs-12 mb-1">
                    <h2 class="content-header-title">Listado de Préstamos</h2>
                </div>
                                ...
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">
                                        ...
                                        if ($tiene_permiso &&  $tiene_permiso["reportes"] >= 1) {
                                            echo '<button id="btn_prestamos_pdf" class="btn  btn-danger"> <i class="fas icon-file-pdf"></i> Descargar Listado</button>';
                                        } ?>
                                    </h4>
                                ...
                                <div class="card-body collapse in">
                                    ...
                                    <div class="card-block">
                                        <div class="table-responsive">
                                            <table id="tabla_prestamos" class="table table-bordered table-sm">
                                                <thead>
                                                    <tr>
                                                        <th width="">Acciones</th>
                                                        <th width="">Nº Préstamo</th>
                                                        <th width="">Nombre Completo</th>
                                                        <th width="">Tipo de Préstamo</th>
                                                        <th width="">Monto</th>
                                                        <th width="">Fecha Desembolso</th>
                                                        <th width="">Plazo</th>
                                                        <th width="">Rubro Negocio</th>
                                                        <th width="">Estado</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
    ...
    <?php include "planPagos.php"; ?>
    <?php  //include "Avales.php"; 
    ?>
    ...
    <script src="../assets/js/generarPDFprestamos.js"></script>
