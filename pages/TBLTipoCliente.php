...
if (isset($_SESSION["user"])) {
	...
	$tiene_permiso = $permiso->ListarPermisosRol(35, $rol);
...
?>
								...
								<div class="card-header">
									<h4 class="card-title" id="basic-layout-form">
										...
										if ($tiene_permiso && $tiene_permiso["insertar"] >= 1) {
											echo '<button class="btn btn-success" data-toggle="modal" data-target="#registral_Tipocliente"><span class="icon-plus"></span> Nuevo</button>';
										}
										if ($tiene_permiso &&  $tiene_permiso["reportes"] >= 1) {
											echo '<button id="btn_descargar_rTipoCliente_pdf" class="btn btn-danger"> <i class="fas icon-file-pdf"></i> Descargar Listado</button>';
										} ?>
									</h4>
								...
								<div class="card-body collapse in">
									<div class="card-block">
										<div class="table-responsive">
											<table id="tabla_tipocliente" class="table table-bordered table-sm">
												<thead>
													<tr>
														<th>Acciones</th>
														<th>No.</th>
	...
	include "Modals/Registrar/RegistrarTipoCliente.php";
	...
	include "Modals/Actualizar/ActualizarTipoCliente.php";
	...
	<script src="../assets/js/listadoTipoCliente.js"></script>
