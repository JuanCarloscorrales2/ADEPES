<div class="modal fade" id="actualizar_Laboral" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
      ...
      <div class="modal-body">
        <form>
          ...
          <div class="form-group">
            ...
            <input type="text"  id="descripcion_laboral_edit" placeholder="Ingrese un tiempo laboral" class="form-control" style="text-transform:uppercase;" onblur="CambiarMayuscula(this);" onkeyup="espacios(this);" maxlength="20" oninput="validarInput(this);">
          </div>
        </form>
      </div>
