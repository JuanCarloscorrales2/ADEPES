<div class="modal fade" id="actualizar_Rubro" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
      ...
      <div class="modal-body">
        <form>
          ...
          <div class="form-group">
            ...
            <input type="text"  id="descripcion_rubro_edit" placeholder="Edite el Rubro" class="form-control" style="text-transform:uppercase;" onblur="CambiarMayuscula(this);" onkeypress="return soloLetras(event)" onkeyup="espacios(this);" maxlength="20" oninput="validarInput(this);">
          </div>
        </form>
      </div>
