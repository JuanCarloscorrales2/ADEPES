      ...
      <div class="modal-body">
        <form autocomplete="off">
          ...
          <div class="form-group">
            ...
            <input class="form-control" placeholder="INGRESE UNA NUEVA PREGUNTA" id="pregunta_editar" style="text-transform:uppercase;" onblur="CambiarMayuscula(this);" onkeypress="return soloLetras(event)" onblur="limpiaNombre()" onkeyup="espacios(this);" maxlength="100" oninput="validarInput(this);"></input>
          </div>
        </form>
      </div>
