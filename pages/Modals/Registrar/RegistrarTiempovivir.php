<div class="modal fade" id="registral_Tiempovivir" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
      ...
      <div class="modal-body">
        <form>
          <div class="form-group">
            ...
            <input type="text"  id="descripcion_Tiempovivir" placeholder="Ingrese un nuevo Tiempo de vivir" class="form-control" style="text-transform:uppercase;" onblur="CambiarMayuscula(this);" onkeyup="espacios(this);" maxlength="20" oninput="validarInput(this);">
          </div>
        </form>
      </div>
