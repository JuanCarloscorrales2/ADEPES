<div class="modal fade" id="registral_Estadocredito" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
      ...
      <div class="modal-body">
        <form>
          <div class="form-group">
            ...
            <input type="text"  id="descripcion_Estadocredito" placeholder="Ingrese un nuevo estado de crédito" class="form-control" style="text-transform:uppercase;" onblur="CambiarMayuscula(this);" onkeypress="return soloLetras(event)" onkeyup="espacios(this);" maxlength="20" oninput="validarInput(this);">
          </div>
        </form>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick ="eventoCerrarModal();">Cerrar</button>
        <button type="button" class="btn btn-primary" onclick="RegistrarEstadoCredito();" >Guardar</button>
      </div>
    </div>
  </div>
</div>
