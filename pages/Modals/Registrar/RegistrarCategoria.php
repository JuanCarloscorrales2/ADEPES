      ...
      <div class="modal-body">
        <form>
          <div class="form-group">
            ...
            <input type="text"  id="descripcion_Categoria" placeholder="Ingrese un nueva Categoria-Casa" class="form-control" style="text-transform:uppercase;" onblur="CambiarMayuscula(this);" onkeypress="return soloLetras(event)" onkeyup="espacios(this);" maxlength="20">
          </div>
        </form>
      </div>
