...
function generarPDF() {
    var datosFiltradosOrdenados = tablaAvala.rows({ search: 'applied', order: 'applied' }).data().toArray();
    ...
    var form = $('<form action="../pages/fpdf/listadoAvalaPersona.php" method="post" target="_blank">');
  ...
  $('#btn_descargar_rAvalaPersona_pdf').on('click', function() {
    generarPDF();
  });
...
function eventoCerrarModal(){
  ...
  if($('#descripcion_Avala').val() != ""){ //validad que los input hayan datos
