...
function LlenarTablaSolicitudes(){
    ...
    $('#tabla_solicitudes').on('search.dt', function(event) {
...
function EventoBitacora(evento){ //registra el evento de pdf
  ...
  $.ajax({
      data: { "evento": evento },
      url:'../controller/SolicitudNuevaController.php?operador=registrarEventoBitacora', //url del controlador Conttroller
      type:'POST',
      beforeSend:function(){},
      success:function(response){
