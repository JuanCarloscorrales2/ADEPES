...
function generarPDF() {
    ...
    EventoBitacora(1, 15, "Imprimió el reporte de LISTADO DE TIPO CONTACTO");//bitacora reporte
  }
...
function eventoCerrarModal(){
  ...
  if($('#descripcion_Contacto').val() != ""){ //validad que los input hayan datos
