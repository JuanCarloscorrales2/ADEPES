...
$('#btn_descargar_reporteEstadoUser_pdf').on('click', function() {
    generarPDF();
});

//funcion para controlar el evento click fuera del modal
function eventoCerrarModal1(){

    if($('#descripcion_estadoU').val() != ""){ //validad que los input hayan datos
      ...
      Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            $('#RegistrarEstadoUser').modal('show');
          }
        });
    }
  }